...
class BarangController extends SecureController{
	...
	function view($rec_id = null, $value = null){
		...
		$db->join("kategori", "barang.Id_Kategori = kategori.Id_Kategori", "INNER");
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Id_Kategori","Nama_Barang","Merek","Spesifikasi","Gambar_Barang","Jumlah_Aset","Nilai_Per_Aset","Id_Ruangan","Id_Kondisi","Asal_Perolehan","Tahun_Perolehan");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("Id_Barang","Id_Kategori","Nama_Barang","Merek","Spesifikasi","Gambar_Barang","Jumlah_Aset","Nilai_Per_Aset","Id_Ruangan","Id_Kondisi","Asal_Perolehan","Tahun_Perolehan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Id_Kategori' => 'required',
