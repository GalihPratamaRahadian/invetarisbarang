                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-Id_Kategori" name="Id_Kategori"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $selected = $this->set_field_selected('Id_Kategori',$value, "");
                                                    ?>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-Nilai_Per_Aset"  value="<?php  echo $this->set_field_value('Nilai_Per_Aset',""); ?>" type="text" placeholder="Enter Nilai Per Aset"  required="" name="Nilai_Per_Aset"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
